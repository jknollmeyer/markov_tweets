...
var PageHTML = React.createClass({
  ...
  resetTweet: function resetTweet(e) {
    ...
    $.ajax({
      ...
      success: (function (data) {
        ...
        //401 Unauthorized Error
          ...
          else if (data == '204') this.setState({ status: 'Account has no tweets to generate a model from' });else if (data == 'UNKNOWN') this.setState({ status: 'Unknown error' });
  ...
  render: function render() {
    ...
    if (this.state.responseSuccess || this.state.loading) {
      ...
      partial = React.createElement(
        'div',
        { style: innerCenterStyle },
        React.createElement(
          'blockquote',
          { className: 'twitter-tweet', style: tweetCardStyle },
          React.createElement(
            'a',
            { href: this.state.profileURL },
            React.createElement('img', { src: this.state.twitPic, style: twitpicStyle })
          ),
          React.createElement(
            'span',
            null,
        ...
        React.createElement(
          ...
          React.createElement(_reactSocial.TwitterButton, { url: 'foo' }),
          React.createElement(
            'button',
            { type: 'button', className: 'btn btn-default',
      ...
      partial = React.createElement(
        ...
        React.createElement(
          'form',
          { className: 'usernameForm', onSubmit: this.handleSubmit },
...
ReactDOM.render(React.createElement(PageHTML, null), document.getElementById('appContainer'));

},{"react":158,"react-dom":1,"react-social":2}],160:[function(require,module,exports){
